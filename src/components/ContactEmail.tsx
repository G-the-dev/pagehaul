    ...
    <div className="rounded-xl border border-border bg-surface p-6 sm:p-7">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <a
          ...
          className="text-[20px] font-semibold tracking-tight text-foreground underline decoration-border-strong underline-offset-4 transition-colors hover:decoration-foreground sm:text-[22px]"
        >
          {SITE.contactEmail}
        </a>
