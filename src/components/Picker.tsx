      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-4 border-b border-border px-6 py-4">
          ...
          <div className="ml-auto flex items-center gap-2.5">
            <input
              ...
              className="w-[190px] rounded-lg border border-border bg-surface px-3 py-2 text-[14px] outline-none transition-colors placeholder:text-muted-foreground focus:border-accent"
            />
            <button
              type="button"
              onClick={onClose}
              aria-label="Close"
              className="rounded-lg border border-border px-2.5 py-2 font-mono text-[12px] text-fg-2 transition-colors hover:border-border-strong hover:text-foreground"
            >
              ESC
            </button>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-4 border-b border-border bg-surface-2/50 px-6 py-2.5">
          ...
          <button
            ...
            className="text-[13.5px] font-medium text-accent transition-opacity hover:opacity-75"
          >
        ...
        <div className="flex flex-wrap items-center gap-4 border-t border-border bg-surface/70 px-6 py-4">
          <div className="flex items-baseline gap-2">
            <span className="text-[17px] font-semibold tabular-nums text-accent">
              {selected.size}
            </span>
          ...
          <div className="ml-auto flex flex-wrap gap-2.5">
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border border-border px-4 py-2 text-[14.5px] font-medium text-fg-2 transition-colors hover:border-border-strong hover:text-foreground"
            >
              Cancel
            </button>
            <button
              ...
              className="rounded-lg border border-border-strong px-4 py-2 text-[14.5px] font-medium text-fg-2 transition-colors hover:border-accent hover:text-foreground disabled:opacity-40"
            >
              Separate files
            </button>
            <button
              ...
              className="rounded-lg bg-accent px-5 py-2 text-[14.5px] font-semibold text-accent-fg transition-all hover:brightness-110 disabled:opacity-40"
            >
